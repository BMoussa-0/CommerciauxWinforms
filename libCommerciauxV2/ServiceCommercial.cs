...
namespace libCommerciauxV2
{
    public class ServiceCommercial
    {
        ...
        {
            return this.getCommercial(nom, prenom);
        }
        ...
        public void AjouterNote(Commercial c, DateTime date, double montant)
        {
            this.MesNotes.Add(new RepasMidi(date, c, montant));
        }

        public void AjouterNote(Commercial c, DateTime date, double montant, char region)
        {
            this.MesNotes.Add(new Nuite(date, c, montant, region));
        }
